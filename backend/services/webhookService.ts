import { Initiative } from './dbService';

export class WebhookService {
    public static async triggerPowerAutomate(action: string, initiative: Initiative, comments?: string) {
    ...
    private static simulateTeamsAdaptiveCard(action: string, initiative: Initiative, comments?: string) {
